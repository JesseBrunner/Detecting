...
We seem to be doing a pretty good job of estimating the True parameter values for the distributions of the starting virus population size and growth rates, even without accounting for the correlation structure in those parameters. 
...
# histogram of the estimated correlation
dens( post2$Rho[,1,2], xlim=c(-1,1), col = "black")
dens( post2b$Rho[,1,2], add=TRUE, col = "blue")
dens(R[,1,2], add=TRUE, lty=2)
