...
curve(dexp(x, rate=TRUE), add = TRUE)
...
OK, all of that was warm-up, model and tool development and testing. It was all meant so that we could be confident we knew how things worked. _Now_ we are ready to fit the model to our actual data!
