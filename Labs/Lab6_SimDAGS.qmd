...
b_EV <- 1 # strong effect of energetic reserves
```
...
It's interesting to see that there is a clear, positive correlation between body condition and virus titers. I could imagine I might have seen these data and been very tempted to include body condition as a predictor of virus titers. Let's try fitting two different models:
